...
window.includeHTML = function (src, destination, callback) {
  ...
  if (src==='places') return includeHTMLplaces;
     ...
     if(destination.hasAttribute("data-include")) destination.setAttribute('data-include',src);if (src.match(/\admin|\.txt*/i))
